...
class service_op:
    ...
    def __init__(self, op_dir, op_csv):
        ...
        self.output_html = f"{op_dir}\\service_report.html"
    ...
    def html_writer(self):
        ...
        <h2>{db.service_db["Heading"]}</h2>

        <p>
            {db.service_db["first_para"]}
        </p>

            <p>
            {db.service_db["second_para"]}
        </p>
        ...
        print("HTML report generated: Services artifacts")
