...
class index_generator:
    ...
    def __init__(self,path,investigator,scan_started, far_date):
        self.investigator = investigator
        self.html_path = f"{path}\\index.html"
        self.far_date = far_date
        self.scan_date = scan_started
    ...
    def html_writer(self):
        ...
        <p>Scan Start Time: <b>{self.scan_date}</b></p>
        <p>Artifacts analyzed starting from:<b> {self.far_date} </b>until the time of analysis.<p>
