...
class browser_op:
    ...
    def __init__(self, op_dir, op_csv):
        ...
        self.output_html = f"{op_dir}\\browser_artifacts.html"
        self.html = None
    ...
    def html_writer(self):
        if not os.path.exists(self.finalize):
            try:
                with open(self.output_html, "w", encoding="utf-8") as f, \
                        open("html_templates/not_found.html", "r", encoding="utf-8") as f2:
                    f.write(f2.read())
        ...
        try:
            ...
            <h2>{db.browser["Heading"]}</h2>

            <p>
                {db.browser["first_para"]}
            </p>

                <p>
                {db.browser["second_para"]}
            </p>
        ...
        print(" HTML report generated : Browser Artifacts\n")
